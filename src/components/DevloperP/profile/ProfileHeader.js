...
const ProfileHeader = ({ userData }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className={`rounded-2xl border shadow-xl overflow-hidden mb-6 transition-all duration-200 ${
        isDarkMode 
          ? 'bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border-gray-700' 
          : 'bg-gradient-to-br from-white to-gray-50 border-gray-200'
      }`}>
        <div className={`p-4 md:p-6 transition-all duration-200 ${
          isDarkMode 
          ...
          <div className="flex flex-col lg:flex-row items-start gap-4 lg:gap-6">
            ...
            <div className="relative mx-auto lg:mx-0">
              <div className={`w-20 h-20 md:w-24 md:h-24 rounded-xl flex items-center justify-center transition-all duration-200 ${
                isDarkMode 
                  ? 'bg-gradient-to-br from-teal-500 to-cyan-600 shadow-lg' 
                  : 'bg-gradient-to-br from-teal-500 to-cyan-600 shadow-lg hover:shadow-xl'
              }`}>
                <span className="text-2xl md:text-3xl font-bold text-white">{initials}</span>
              </div>
              <div className={`absolute -bottom-2 -right-2 w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center border-2 transition-all duration-200 ${
                isDarkMode 
                  ? 'bg-gray-800 border-teal-500 shadow-md' 
            ...
            <div className="flex-1 text-center lg:text-left">
              <h1 className={`text-2xl md:text-3xl font-bold mb-2 bg-gradient-to-r bg-clip-text text-transparent transition-all duration-200 ${
                isDarkMode 
              ...
              <p className={`text-base md:text-lg mb-3 transition-all duration-200 ${
              ...
              <div className="mb-3">
                <div className={`flex justify-between items-center text-xs mb-1 transition-all duration-200 ${
                ...
                <div className={`w-full rounded-full h-2 overflow-hidden transition-all duration-200 ${
                  ...
                  <div 
                    className="h-full bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full transition-all duration-300 shadow-md shadow-teal-500/50"
              ...
              {/* Location */}
              {userData.location && (
                <div className={`flex items-center gap-2 text-sm mb-4 transition-all duration-200 ${
                  isDarkMode ? 'text-gray-300' : 'text-gray-600'
                }`}>
                  ...
                  <div className="flex flex-col items-center gap-1">
                    <a 
                      ...
                      className={`w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110 ${
                        isDarkMode ? 'bg-blue-600 hover:bg-blue-700' : 'bg-blue-500 hover:bg-blue-600 hover:shadow-lg'
                      }`}
                    >
                ...
                {(userData.github || true) && (
                  <div className="flex flex-col items-center gap-1">
                    <a 
                      ...
                      rel="noopener noreferrer"
                      className={`w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110 ${
                        isDarkMode ? 'bg-gray-800 hover:bg-gray-900' : 'bg-gray-700 hover:bg-gray-800 hover:shadow-lg'
                      }`}
                    >
                      <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 0C4.477 0 0 4.484 0 10.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0110 2.836c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.203 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.942.359.308.678.92.678 1.852 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0020 10.017C20 4.484 15.522 0 10 0z" clipRule="evenodd"/>
                ...
                {(userData.email || true) && (
                  <div className="group relative">
                    <a 
                      ...
                      className={`w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110 ${
                        isDarkMode ? 'bg-red-500 hover:bg-red-600' : 'bg-red-500 hover:bg-red-600 hover:shadow-lg'
                      }`}
                    >
                      <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/>
                    ...
                    <span className={`absolute -bottom-5 left-1/2 transform -translate-x-1/2 text-xs px-2 py-1 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-200 whitespace-nowrap ${
                      isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-800 text-white shadow-md'
                    }`}>
                ...
                {(userData.phone || true) && (
                  <div className="group relative">
                    <a 
                      ...
                      className={`w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110 ${
                        isDarkMode ? 'bg-green-500 hover:bg-green-600' : 'bg-green-500 hover:bg-green-600 hover:shadow-lg'
                      }`}
                    >
                      <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
