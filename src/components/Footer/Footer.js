...
function Footer() {
  ...
  return (
    <footer className={`border-t transition-all duration-300 ${
      ...
      backgroundColor: isDarkMode ? '#20232A' : '#f9f9f9'
    }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <a href="#" className={`w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300 group ${
                isDarkMode 
                  ? 'bg-[#0d8383]/20 hover:bg-[#0d8383]/30' 
                  : 'bg-teal-100 hover:bg-teal-200'
              }`}>
                <svg className={`w-5 h-5 transition-colors ${
                  isDarkMode 
                    ? 'text-gray-300 group-hover:text-[#0d8383]' 
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h4 className={`text-lg font-semibold mb-4 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>Quick Links</h4>
            <ul className="space-y-2">
              <li>
                <Link to="/about" className={`transition-colors duration-300 ${
                  isDarkMode 
                    ? 'text-gray-400 hover:text-[#11a3a3]' 
              ...
              <li>
                <Link to="/jobs" className={`transition-colors duration-300 ${
                  isDarkMode 
                    ? 'text-gray-400 hover:text-[#11a3a3]' 
                    : 'text-gray-600 hover:text-teal-600'
                }`}>
              ...
              <li>
                <Link to="/companies" className={`transition-colors duration-300 ${
                  isDarkMode 
                    ? 'text-gray-400 hover:text-[#11a3a3]' 
                    : 'text-gray-600 hover:text-teal-600'
                }`}>
              ...
              <li>
                <Link to="/dashboard/main" className={`transition-colors duration-300 ${
                  isDarkMode 
                    ? 'text-gray-400 hover:text-[#11a3a3]' 
                    : 'text-gray-600 hover:text-teal-600'
                }`}>
          ...
          {/* Contact & Legal */}
          <div className="space-y-4">
            <h4 className={`text-lg font-semibold mb-4 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>Support</h4>
            <ul className="space-y-2">
              <li>
                <Link to="/contact" className={`transition-colors duration-300 ${
                  isDarkMode 
                    ? 'text-gray-400 hover:text-[#0d8383]' 
              ...
              <li>
                <Link to="/help" className={`transition-colors duration-300 ${
                  isDarkMode 
                    ? 'text-gray-400 hover:text-[#0d8383]' 
                    : 'text-gray-600 hover:text-cyan-600'
                }`}>
