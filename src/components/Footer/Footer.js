      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-gradient-to-br from-[#11a3a3] to-[#0d8383] rounded-xl flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 5a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clipRule="evenodd"/>
                </svg>
              </div>
              <h3 className="text-xl font-bold bg-gradient-to-r from-[#11a3a3] to-[#0d8383] bg-clip-text text-transparent">
                TechConnect AI
              </h3>
            </div>
            ...
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 bg-[#0d8383]/20 hover:bg-[#0d8383]/30 rounded-lg flex items-center justify-center transition-all duration-300 group">
                <svg className="w-5 h-5 text-gray-300 group-hover:text-[#0d8383] transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/about" className="text-gray-400 hover:text-[#11a3a3] transition-colors duration-300">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/jobs" className="text-gray-400 hover:text-[#11a3a3] transition-colors duration-300">
                  Find Jobs
                </Link>
              </li>
              <li>
                <Link to="/companies" className="text-gray-400 hover:text-[#11a3a3] transition-colors duration-300">
                  Companies
                </Link>
              </li>
              <li>
                <Link to="/dashboard/main" className="text-gray-400 hover:text-[#11a3a3] transition-colors duration-300">
                  Dashboard
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/contact" className="text-gray-400 hover:text-[#0d8383] transition-colors duration-300">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link to="/help" className="text-gray-400 hover:text-[#0d8383] transition-colors duration-300">
                  Help Center
                </Link>
              </li>
              <li>
                <Link to="/privacy" className="text-gray-400 hover:text-[#0d8383] transition-colors duration-300">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/terms" className="text-gray-400 hover:text-[#0d8383] transition-colors duration-300">
                  Terms of Service
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-gray-400 text-sm">
              Made with <span className="text-[#11a3a3]">♥</span> for Arab tech companies
            </div>
          </div>
        </div>
      </div>
