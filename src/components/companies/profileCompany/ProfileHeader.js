        ...
        <div className="bg-gradient-to-r from-teal-600/20 to-cyan-600/20 p-6 md:p-8">
          <div className="flex flex-col lg:flex-row items-start gap-6 lg:gap-8">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-lg md:text-xl text-gray-300 mb-4">{companyData.title}</p>
              
              {/* Bio Section */}
              {companyData.description && (
                <div className="mb-6 p-4 bg-gray-800/50 rounded-xl border border-gray-600">
                  <p className="text-gray-300 leading-relaxed text-sm md:text-base">{companyData.description}</p>
                </div>
              )}
                ...
                {(companyData.email || true) && (
                  <div className="group relative">
                    <a 
                      ...
                      className="w-12 h-12 bg-red-500 hover:bg-red-600 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg"
                    >
                      <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/>
                        <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/>
                ...
                {(companyData.phone || true) && (
                  <div className="group relative">
                    <a 
                      ...
                      className="w-12 h-12 bg-green-500 hover:bg-green-600 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg"
                    >
                      <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
                      </svg>
